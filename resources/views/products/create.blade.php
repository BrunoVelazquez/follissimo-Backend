        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 mr-auto">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('products.store') }}" enctype="multipart/form-data" class="w-1/2">
                        @csrf
                        <div class="mb-4">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="description" class="block mt-1 w-full border-gray-300 dark:border-gray-700 rounded-md shadow-sm focus:ring focus:ring-opacity-50 dark:bg-gray-700 dark:text-gray-100" name="description" required></textarea>
                                    ...
                                    <x-slot name="trigger">
                                        <button type="button" class="flex items-center justify-between mt-1 w-full text-left border border-gray-300 dark:border-gray-700 rounded-md shadow-sm px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                            <span id="category_label">
                                                {{ $categories->firstWhere('id', old('category_id'))?->name ?? 'Seleccionar categoría...' }}
                                            </span>
                            ...
                            <div class="mb-4">
                                ...
                                <x-dropdown align="left" width="48">
                                    <x-slot name="trigger">
                                        <button type="button" class="flex items-center justify-between mt-1 w-full text-left border border-gray-300 dark:border-gray-700 rounded-md shadow-sm px-3 py-2 dark:bg-gray-700 dark:text-gray-100">
                                            <span id="size_label">
                                                {{ $sizes->firstWhere('id', old('size_id'))?->name ?? 'Seleccionar talle...' }}
                                            </span>
                                            <svg class="h-5 w-5 text-gray-400 ml-2 -mr-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                                <path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd" />
                                            </svg>
                                ...
                                <input type="hidden" id="size_id" name="size_id" value="{{ old('size_id') }}">
